...
CREATE TABLE users (
    ...
    locale character varying(255) DEFAULT 'zh-CN'::character varying,
...
--
-- Name: index_posts_on_hot; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_posts_on_hot ON posts USING btree (hot);
...
INSERT INTO schema_migrations (version) VALUES ('20140609113303');

INSERT INTO schema_migrations (version) VALUES ('20140610155413');
