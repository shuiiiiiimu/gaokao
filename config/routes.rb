...
Rails.application.routes.draw do
  ...
  resources :posts, only: [:index, :show, :new, :create, :edit, :update], concerns: [:commentable, :likeable, :subscribable] do
    collection do
      get 'categoried/:category_id', to: 'posts#index', as: :categoried
      get 'search'
    end
